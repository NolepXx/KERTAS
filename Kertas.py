...
sys.stdout.write('\x1b]2; SMBF| NolepXx \x07')
#------------------[ USER-AGENT ]-------------------#
uman,usman1=[],[]
pretty.install()
CON=sol()
...
:*++@*+*=++++*##**=:.:--:#.   ==.                         =+.   #---:.:=+*##*++++=+**@++*:
 ...
 ______ ___ ___ _______ _______ _______ _______ _____   
|      |   |   |    |  |   _   |   |   |       |     |_ 
|   ---|\     /|       |       |       |   -   |       |
|______| |___| |__|____|___|___|__|_|__|_______|_______|
                                                        
 _______ ______ _______ ___ ___                         
|   _   |   __ \   |   |   |   |                        
|       |      <       |\     /                         
|___|___|___|__|__|_|__| |___|                          

             """,width=100,padding=(0,4),title=f"NOLEPXXX",style=f"bold cyan"))
#--------------------[ BAGIAN-MASUK ]--------------#
def login123():
	os.system('clear')
	banner()
...
def menu(my_name,my_id):
	...
	cetak(panel(f"[bold white]Alvino_Xy , DerrXr , Asepit-Gans , Rozhak XD , Dapunta , Nazri XD And AOREC XD",width=90,title=f"[bold green]Thanks To",padding=(0,5),style=f"bold cyan"))
...
def pengikut():
	...
	try:
		...
		print("\r")
		cetak(panel(f"Berhasil Mengumpulkan {len(id)} Idz",width=90,padding=(0,22),style=f"bold cyan"))
		setting()
	except requests.exceptions.ConnectionError:
